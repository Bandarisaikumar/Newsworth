...
import com.example.newsworth.databinding.FragmentAboutAppScreenBinding

class AboutAppScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAboutAppScreenBinding.inflate(inflater, container, false)
        return binding.root
    }
